        ...
        echo "<div id='moduloZona'>";
          echo "<span class = 'tituloSpot'>";
            ...
            echo "<div class='textoDependiente'>";
                echo "\"Un buen descanso después de buscar los tesoros enterrados\".";
            ...
            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="camastroBurdel">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Camastro de Burdel';
                        echo "</div>";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="camaMeretriz">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Cama de Meretriz';
                        echo "</div>";
            ...
            echo "</span>"; //FIN Contenedor1
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(164);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(164);
