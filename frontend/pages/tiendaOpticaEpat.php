...
global $db;
        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                //FIN INFOOBJETO 1
                //INFOOBJETO 2
                     echo "<div id='infoObjeto2' class='infoObjeto objetoCabeza'>";
                    $result = getObjeto(115);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                //FIN INFOOBJETO 2
                //INFOOBJETO 3
                     echo "<div id='infoObjeto3' class='infoObjeto objetoCabeza'>";
                    $result = getObjeto(116);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            $imagenParche = getFotoObjeto(114);
                            $imagenIntelectual = getFotoObjeto(115);
                            $imagenSol = getFotoObjeto(116);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="parcheOjo">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Parche para Ojo izquierdo';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenParche . '</div><div class="monedaTienda"></div><div class="precioTienda">150</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="gafasIntelectual">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Gafas de Intelectual';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenIntelectual . '</div><div class="monedaTienda"></div><div class="precioTienda">500</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="gafasSol">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Gafas de Sol polarizadas';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenSol . '</div><div class="monedaTienda"></div><div class="precioTienda">500</div></label>';
                            echo "</div>";
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(104);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(104);
