                ...
                $mostrar = comprobarMision(3);
                    echo "<div class='textoDependiente'>";
                            ...
                            if($mostrar === 1){ //Está activada y en progreso en
                                ...
                                if($progreso === '3'){
                                    echo "¡Lo conseguimos! Ahora clicka para recibir tu premio y pongámonos en camino hacia el Restaurante Casa Ginés, situado en el Terri.";
                                }
                                elseif($progreso === '4'){
                        ...
                        echo "</div>"; //FIN textoDependiente
                        echo "<div class='imagenDependiente'>";
                            if($mostrar === 2 || ($mostrar === 1 && ($progreso === '1' || $progreso === '2' || $progreso === '5'))){ //Aún no está activada o lo está pero en una fase ya avanzada
                                echo '<img src="/design/img/dependientes/yoHombre.png">';
                            }
                            else{
