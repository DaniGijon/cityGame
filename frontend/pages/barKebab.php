                ...
                echo "<span class='contenedor1'>"; 
                    ...
                    echo "<div id='salon'>";
                        echo "<div class='textoDependiente'>";
                            echo "\"¿Vienes de natación? ¡Kebab con Guarnición! ¿Vas a la carrera? ¡Durum de ternera!\".";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="boteRefresco">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Bote de Refresco';
                        echo "</div>";
