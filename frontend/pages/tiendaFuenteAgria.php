                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Refrescante, de sabor ferroso y un ligero toque de gas\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/yoHombre.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagen1 = getFotoObjeto(923);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="botellaAguaAgria">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Botella Agua Agria';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen1 . '</div><div class="monedaTienda"></div><div class="precioTienda">0</div></label>';
                            echo "</div>";
