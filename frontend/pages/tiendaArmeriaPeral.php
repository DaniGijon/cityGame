        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                echo "<div class='seccionSpotOpciones'>";   
                    ...
                    //INFOOBJETO 1
                     echo "<div id='infoObjeto1' class='infoObjeto objetoTorso'>";
                    $result = getObjeto(209);
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"¡Ey! Cuánto tiempo, colega\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/funkyKong.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagen1 = getFotoObjeto(209);
                            $imagen2 = getFotoObjeto(316);
                            $imagen3 = getFotoObjeto(310);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="kitCamuflaje">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Kit de Camuflaje';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen1 . '</div><div class="monedaTienda"></div><div class="precioTienda">600</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="machete">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Machete afilado';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen2 . '</div><div class="monedaTienda"></div><div class="precioTienda">1000</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="revolver">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Revólver cal.45';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen3 . '</div><div class="monedaTienda"></div><div class="precioTienda">1600</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"¿Estamos hablando de un trato?\"";
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(113);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(113);
