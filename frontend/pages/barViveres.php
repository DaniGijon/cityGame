                ...
                echo "<span class='contenedor1'>"; 
                    ...
                    echo "<div id='salon'>";
                        echo "<div class='textoDependiente'>";
                            echo "\"¡No me hagas perder el tiempo! Entrega urgente a Castillo Negro\".";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="cuencoSopa">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Cuenco de Sopa Caliente';
                        echo "</div>";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="cervezaNegra">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Cerveza Negra';
                        echo "</div>";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="blackPudding">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Black Pudding';
                        echo "</div>";
            ...
            echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "</div>";
                     ...
                     echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(166);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(166);
