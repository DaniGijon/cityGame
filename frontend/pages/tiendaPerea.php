        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                echo "<div class='seccionSpotOpciones'>";   
                    ...
                    //INFOOBJETO 1
                     echo "<div id='infoObjeto1' class='infoObjeto objetoPies'>";
                    $result = getObjeto(400);
                ...
                //FIN INFOOBJETO 1
                //INFOOBJETO 2
                     echo "<div id='infoObjeto2' class='infoObjeto objetoMochila'>";
                    $result = getObjeto(504);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Date prisa porque con estos precios en calzado, quien no corre, vuela\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagen1 = getFotoObjeto(400);
                            $imagen2 = getFotoObjeto(504);
                            $imagen3 = getFotoObjeto(409);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="chanclas">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Chanclas de Piscina';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen1 . '</div><div class="monedaTienda"></div><div class="precioTienda">170</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="mochilaCuerdas">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Mochila de Cuerdas';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen2 . '</div><div class="monedaTienda"></div><div class="precioTienda">300</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="botasLevitacion">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Botas de Levitación';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen3 . '</div><div class="monedaTienda"></div><div class="precioTienda">6250</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"Así que me quieres calzar algo\".";
