                ...
                echo "<span class='contenedor1'>"; 
                    ...
                    echo "<div id='salon'>";
                        echo "<div class='textoDependiente'>";
                            echo "\"Porque el levantamiento de jarra también es un deporte\".";
                    ...
                    echo "<div class='opcionesTienda'>";
                        echo "<div class='opcionesTiendaCheckbox'>";
                            echo '<input type="checkbox" name="cbox1" value="bocataGuitarra">';
                        echo "</div>";
                        echo "<div class='opcionesTiendaTitulo'>";
                            echo 'Bocata Guitarra';
                        echo "</div>";
                        echo '<label for="cbox3"><div id="opcionBox">' . '<img src="/design/img/bar/cafeIrlandes">' . '</div><div class="monedaTienda"></div><div class="precioTienda">25</div><div class="corazonTienda"></div><div class="vidaTienda">+3</div></label>';
                    echo "</div>";
            ...
            echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "</div>";
                     ...
                     echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(178);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(178);
