            ...
            echo "<span class='contenedor1'>"; 
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"¿Sabes que este supermercado empezó siendo un videoclub? Adaptarse o morir\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenPan = getFotoObjeto(311);
                            $imagenGalletas = getFotoObjeto(932);
                            ...
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                ...
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenPan . '</div><div class="monedaTienda"></div><div class="precioTienda">60</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="galletasMaiz">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Galletas de Maíz';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenGalletas . '</div><div class="monedaTienda"></div><div class="precioTienda">200</div></label>';
                            echo "</div>";
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(92);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(92);
