...
global $db;
        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                echo "<div class='seccionSpotOpciones'>";
                    echo "<div class='semiTransparente'>";
                        echo "<div class='textoDependiente'>";
                            echo "\"Nos reunimos a pedir Fuerza para la batalla\".";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=social&nonUI' method='post'>";
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="oracionesAntiguos">';
                                echo "</div>";
                                echo "<label for='cbox1'>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Cantar oraciones';
                                echo "</div>";
                            ...
                            echo '<div class="opcionesTiendaCheckbox"><input type="checkbox" name="cbox1" value="donarAntiguos"></div><label for="cbox4"><div class="opcionesTiendaTitulo">Hacer una ofrenda</div><div id="opcionBox"><img src="/design/img/entrenamiento/ritmitoGeneroso.png"></div><div class="monedaTienda"></div><div class="precioTiendaInput"><input name="cantidadDonacion" style="width:70%; border-radius:10px;" type=number min="100"></div></label>';
                            echo "</div>";
                ...
                echo "<div class='semiTransparente'>";
                   $popularidadAqui = getPopularidadSpot(165);
