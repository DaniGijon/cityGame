                ...
                echo "<span class='contenedor1'>";
                    ...
                    echo "<div class='semiTransparente'>"; 
                        ...
                        echo "<div class='textoDependiente'>";
                            echo "\"Veo menos que un muerto tumbao bocabajo\".";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=aventuras&action=zona&nonUI' method='post'>";
                        echo "<div class='opcionesTienda'>";
                            echo "<div class='opcionesTiendaCheckbox'>";
                                echo '<input type="checkbox" name="cbox1" value="aventuraNiebla">';
                            echo "</div>";
                            echo "<div class='opcionesTiendaTitulo'>";
                                echo 'Explorar Niebla';
                            echo "</div>";
                        ...
                        echo "<div class='opcionesTienda'>";
                            echo "<div class='opcionesTiendaCheckbox'>";
                                echo '<input type="checkbox" name="cbox1" value="aventuraNieblaDebil">';
                            echo "</div>";
                            echo "<div class='opcionesTiendaTitulo'>";
                                echo 'Rodear la Zona';
                            echo "</div>";
                    ...
                    <script>
                       ...
                       $(":checkbox").change(function(){
                        ...
                        $(":checkbox").click(function(){
                            ...
                            if (valor === 'aventuraNiebla') {
                                $(".opcionSpot1").show();
                                $(".opcionSpot2").hide();
                                $(".opcionSpot0").hide();
                            }
                            else if (valor === 'aventuraNieblaDebil'){
                                $(".opcionSpot2").show();
                                $(".opcionSpot1").hide();
                                $(".opcionSpot0").hide();
                            }
                    ...
                    echo "<span class='contenedor2'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        echo "<div class='semiTransparente' style='border-radius: 0px 0px 10px 10px'>";
                                            $descripcionZona = "La niebla es espesa y el frío es cortante, pero quién sabe la de tesoros que habrá ahí delante.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        echo "<div class='semiTransparente' style='border-radius: 0px 0px 10px 10px'>";
                                            $descripcionZona = "Rodeando la Niebla no creo que me encuentre con monstruos muy muy muy poderosos.";
                                            echo $descripcionZona;
                                        echo "</div>";
                                    echo "</span>";
