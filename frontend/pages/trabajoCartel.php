                    ...
                    echo "<div class='semiTransparente'>";
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Tú conoces el negocio y yo conozco la química\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/heisenberg.png">';
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=accionSpot&nonUI' method='post'>";
                            ...
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="trapicheo">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Trapichear para él';
                                echo "</div>";
                            ...
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="ajusteCuentas">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Ajuste de Cuentas';
                                echo "</div>";
                    ...
                    echo "<span class='contenedor2'>";
                            ...
                            echo "<div class='opcionSpot1 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Me quedaré trabajando hasta vender toda la mercancía.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    echo "<div class='semiTransparente'>";
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Hoy el jefe me necesita para visitar a uno de sus socios.";
                                        echo $descripcionZona;
                                    echo "</span>";
                                    echo "</div>";
