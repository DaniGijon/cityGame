        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                echo "<div class='seccionSpotOpciones'>";   
                    ...
                    //INFOOBJETO 1
                     echo "<div id='infoObjeto1' class='infoObjeto objetoMascota'>";
                    $result = getObjeto(4);
                ...
                //FIN INFOOBJETO 1
                //INFOOBJETO 2
                     echo "<div id='infoObjeto2' class='infoObjeto objetoMascota'>";
                    $result = getObjeto(5);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                //FIN INFOOBJETO 2
                //INFOOBJETO 3
                     echo "<div id='infoObjeto3' class='infoObjeto objetoMascota'>";
                    $result = getObjeto(6);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"¡Amos k cosiiiilla!\"";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/yoHombre.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenGato = getFotoObjeto(4);
                            $imagenPerro = getFotoObjeto(5);
                            $imagenCaballo = getFotoObjeto(6);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="gato">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Gato';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenGato . '</div><div class="monedaTienda"></div><div class="precioTienda">200</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="perro">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Perro';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenPerro . '</div><div class="monedaTienda"></div><div class="precioTienda">350</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="caballo">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Caballo';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenCaballo . '</div><div class="monedaTienda"></div><div class="precioTienda">1750</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"¿Me traes un nuevo amiguete pulgoso?\"";
