            ...
            echo "<span class='contenedor1'>"; 
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Tú lo que necesitas es una buena moto y recorrer Puertollano\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenCascoMoto = getFotoObjeto(111);
                            $imagenMotoScooter = getFotoObjeto(25);
                            ...
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="motoScooter">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Moto Scooter';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenMotoScooter . '</div><div class="monedaTienda"></div><div class="precioTienda">8000</div></label>';
                            echo "</div>";
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(183);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(183);
