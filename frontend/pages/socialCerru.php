...
global $db;
        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                echo "<div class='seccionSpotOpciones'>";
                    echo "<div class='semiTransparente'>";
                        echo "<div class='textoDependiente'>";
                            echo "\"El equipo del Calvo Sotelo Puertollano gesta aquí sus grandes hazañas\".";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=social&nonUI' method='post'>";
                            ...
                            echo '<div class="opcionesTiendaCheckbox"><input type="checkbox" name="cbox1" value="donarChorizo"></div><label for="cbox4"><div class="opcionesTiendaTitulo">Donar pasta para fichajes</div><div id="opcionBox"><img src="/design/img/entrenamiento/ritmitoGeneroso.png"></div><div class="monedaTienda"></div><div class="precioTiendaInput"><input name="cantidadDonacion" style="width:70%; border-radius:10px;" type=number min="100"></div></label>';
                            echo "</div>";
                ...
                echo "<div class='semiTransparente'>";
                   $popularidadAqui = getPopularidadSpot(65);
