                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=social&nonUI' method='post'>";
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="funcionAuditorio">';
                                echo "</div>";
                                echo "<label for='cbox1'>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Asistir a la Función';
                                echo "</div>";
                            ...
                            echo '<div class="opcionesTiendaCheckbox"><input type="checkbox" name="cbox1" value="donacionAuditorio"></div><label for="cbox4"><div class="opcionesTiendaTitulo">Dar un Donativo</div><div id="opcionBox"><img src="/design/img/entrenamiento/ritmitoGeneroso.png"></div><div class="monedaTienda"></div><div class="precioTiendaInput"><input name="cantidadDonacion" style="width:70%; border-radius:10px;" type=number min="100"></div></label>';
                            echo "</div>";
                            /*
                                echo "<div class='opcionesTiendaCheckbox'>";
...
*/
                ...
                echo "<div class='semiTransparente'>";
                   $popularidadAqui = getPopularidadSpot(95);
