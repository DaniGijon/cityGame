                    ...
                    echo "<div class='semiTransparente'>";
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"La ambición por ser el mejor comerciante es desmesurada, y a veces a cualquier precio.\"";
                            echo "</div>";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=accionSpot&nonUI' method='post'>";
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="sabotearMercancia">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Sabotear Mercancía';
                                echo "</div>";
                            ...
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="sabotearMobiliario">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Sabotear Mobiliario';
                                echo "</div>";
                            ...
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="sabotearGresca">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Armar Gresca';
                                echo "</div>";
                    ...
                    <script>
                       ...
                       $(":checkbox").change(function(){
                        ...
                        $(":checkbox").click(function(){
                            ...
                            if (valor === 'sabotearMercancia') {
                                $(".opcionSpot1").show();
                                $(".opcionSpot2").hide();
                                $(".opcionSpot3").hide();
                                $(".opcionSpot0").hide();
                            }
                            else if (valor === 'sabotearMobiliario'){
                                $(".opcionSpot2").show();
                                $(".opcionSpot1").hide();
                                $(".opcionSpot3").hide();
                                $(".opcionSpot0").hide();
                            }
                            else if (valor === 'sabotearGresca'){
                                $(".opcionSpot3").show();
                                $(".opcionSpot1").hide();
                                $(".opcionSpot2").hide();
                                $(".opcionSpot0").hide();                                
                    ...
                    echo "<span class='contenedor2'>";
                            ...
                            echo "<div class='opcionSpot1 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Laxante en la comida, un incendio en el almacén... todo vale para machacar un negocio rival.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    echo "<div class='semiTransparente'>";
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Sería una pena que alguna mañana tu local aparezca más destrozado que el campo de batalla de Goku.";
                                        echo $descripcionZona;
                                    echo "</span>";
                                    echo "</div>";
                            ...
                            echo "</div>"; //FIN opcionSpot2
                             ...
                             echo "<div class='opcionSpot3 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    echo "<div class='semiTransparente'>";
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Reúne a la banda y vamos a molestar clientes. Te aseguro que no tendrán ganas de volver nunca más.";
                                        echo $descripcionZona;
                                    echo "</span>";
                                    echo "</div>";
                                echo "</div>"; //Fin descripcionZonaTexto
