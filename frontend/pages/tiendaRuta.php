            ...
            echo "<span class='contenedor1'>"; 
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Una de estas se parece a tu próxima bici. ¿Cuál dices que es?\"";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenCascoBici = getFotoObjeto(113);
                            $imagen2 = getFotoObjeto(32);
                            $imagen3 = getFotoObjeto(33);
                            ...
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="biciMontaña">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Bici de Montaña';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen2 . '</div><div class="monedaTienda"></div><div class="precioTienda">4250</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="biciCarretera">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Bici de Carretera';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagen3 . '</div><div class="monedaTienda"></div><div class="precioTienda">6750</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"¿Y dices que algo de eso será pronto mío?\"";
                ...
                echo "<div class='seccionSpotInfo'>";
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(121);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(121);
