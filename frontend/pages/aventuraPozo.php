                ...
                echo "<span class='contenedor1'>";
                    ...
                    echo "<div class='semiTransparente'>"; 
                        echo "<div class='textoDependiente'>";
                            echo "En la noche vagan los espíritus de quienes tiempo atrás dejaron su vida en el pozo minero.";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=aventuras&action=zona&nonUI' method='post'>";
                        echo "<div class='opcionesTienda'>";
                            echo "<div class='opcionesTiendaCheckbox'>";
                                echo '<input type="checkbox" name="cbox1" value="aventuraPozo">';
                            echo "</div>";
                            echo "<div class='opcionesTiendaTitulo'>";
                                echo 'Explorar la Oscuridad';
                            echo "</div>";
                        ...
                        echo "<div class='opcionesTienda'>";
                            echo "<div class='opcionesTiendaCheckbox'>";
                                echo '<input type="checkbox" name="cbox1" value="aventuraPozoDebil">';
                            echo "</div>";
                            echo "<div class='opcionesTiendaTitulo'>";
                    ...
                    <script>
                       ...
                       $(":checkbox").change(function(){
                        ...
                        $(":checkbox").click(function(){
                            ...
                            if (valor === 'aventuraPozo') {
                                $(".opcionSpot1").show();
                                $(".opcionSpot2").hide();
                                $(".opcionSpot0").hide();
                            }
                            else if (valor === 'aventuraPozoDebil'){
                                $(".opcionSpot2").show();
                                $(".opcionSpot1").hide();
                                $(".opcionSpot0").hide();
                            }
                    ...
                    echo "<span class='contenedor2'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        echo "<div class='semiTransparente' style='border-radius: 0px 0px 10px 10px'>";
                                            $descripcionZona = "Adentrarme a explorar los secretos y tesoros que se esconden en la oscuridad del Parque.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        echo "<div class='semiTransparente' style='border-radius: 0px 0px 10px 10px'>";
                                            $descripcionZona = "Intentaré pasar por el Parque sin meterme en líos gordos.";
                                            echo $descripcionZona;
                                        echo "</div>";
                                    echo "</span>";
