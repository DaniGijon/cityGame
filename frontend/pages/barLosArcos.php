                ...
                $mostrar = comprobarMision(3);
                    echo "<div class='textoDependiente'>";
                            ...
                            if($mostrar === 1){ //Está activada y en progreso en
                                ...
                                if($progreso === '1'){
                                    echo "¡Lo conseguimos! Ahora clicka para recibir tu premio y pongámonos en camino hacia el Asador del Club, situado en El Poblado.";
                                }
                                elseif($progreso === '2'){
                        ...
                        echo "</div>"; //FIN textoDependiente
                        echo "<div class='imagenDependiente'>";
                            if($mostrar === 0 || ($mostrar === 1 && ($progreso === '3' || $progreso === '4' || $progreso === '5'))){ //Aún no está activada o lo está pero en una fase ya avanzada
                                echo '<img src="/design/img/dependientes/yoHombre.png">';
                            }
                            else{
