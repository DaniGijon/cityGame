                    ...
                    echo "<div class='semiTransparente'>";
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Aquí todas las mañanas reventamos balones y redes. Necesitamos más utilleros\".";
                            echo "</div>";
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=accionSpot&nonUI' method='post'>";
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="darBebida">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Dar bebida a los chicos';
                                echo "</div>";
                            ...
                            echo "<div class='opcionesTienda'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="coser">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Coser redes y balones';
                                echo "</div>";
                    ...
                    echo "<span class='contenedor2'>";
                            ...
                            echo "<div class='opcionSpot1 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Esos saltos y acrobacias necesitan de agua y de líquido para amortiguadores.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    echo "<div class='semiTransparente'>";
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Porque quién sabe si por aquí hay ojeadores de alguna multinacional.";
                                        echo $descripcionZona;
                                    echo "</span>";
                                    echo "</div>";
