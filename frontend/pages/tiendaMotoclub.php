            ...
            echo "<span class='contenedor1'>"; 
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"¡Brooom, brooooom! ¡BROOOOOOOOM!\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenPanuelo = getFotoObjeto(117);
                            $imagenMinimoto = getFotoObjeto(24);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="panuelo">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Pañuelo motero';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenPanuelo . '</div><div class="monedaTienda"></div><div class="precioTienda">700</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"Necesito tu ropa, tus botas... ¡Y TU MOTOCICLETAAAA!.\"";
