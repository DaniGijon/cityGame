            ...
            echo "</span>";
                ...
                echo "<span class='contenedor1'>"; 
                    ...
                    echo "<form id = 'selectorOpciones' action='?bPage=actualizaciones&action=accionSpot&nonUI' method='post'>";
                        ...
                        echo "<div class='opcionesTienda'>";
                            echo "<label><input type='checkbox' name='cbox1' value='jardinFantasma'>Jardín<div id='opcionBox'><img src='/design/img/entrenamiento/ritmitoGeneroso.png'></div><div class='relojMini'></div><div class='precioTienda'>1H</div></label>";
                        echo "</div>";
                        
                        echo "<div class='opcionesTienda'>";
                            echo "<label><input type='checkbox' name='cbox1' value='galeriaFantasma'>Galería<div id='opcionBox'><img src='/design/img/entrenamiento/ritmitoGeneroso.png'></div><div class='relojMini'></div><div class='precioTienda'>1H</div></label>";
                        echo "</div>";
                    ...
                    echo "<span class='contenedor2'>";
                            ...
                            echo "<div class='opcionSpot1 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Estoy viendo una figura deforme y desaliñada en cada espejo y empiezo a sospechar que no es mi reflejo.";
                            ...
                            echo "<div class='opcionSpot2 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "¡Hay una maldita Planta Piraña Enorme ahí! Está devorando todo lo que pasa por el Jardín.";
                                        echo $descripcionZona;
                                    echo "</span>";
                            ...
                            echo "</div>"; //FIN opcionSpot2
                             ...
                             echo "<div class='opcionSpot3 opcionSpot'>";
                                ...
                                echo "<div class='seccionDescripcionZonaTexto'>";
                                    ...
                                    echo "<span class='textoDescripcionSpot'>";
                                        $descripcionZona = "Un lamento desgarrador viene desde las profundidades de la Galería. Parece decir: \"¡No queda papeeeeel!\".";
                                        echo $descripcionZona;
                                    echo "</span>";
                                echo "</div>"; //Fin descripcionZonaTexto
