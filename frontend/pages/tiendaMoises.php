...
global $db;
        ...
        echo "<div id='moduloZona'>";
            ...
            echo "<span class='contenedor1'>"; 
                ...
                //FIN INFOOBJETO 1
                //INFOOBJETO 2
                     echo "<div id='infoObjeto2' class='infoObjeto objetoMano'>";
                    $result = getObjeto(315);
                    if($result[0]['nombre'] != 'Vacio'){
                        echo "<b>" . $result[0]['nombre'] . "</b><br><br>";
                    }
                ...
                foreach($objetosDesequipados as $objetoVenta){
                    ...
                    $i++;
                        ...
                        echo "<div id='comprar'>";
                            ...
                            echo "<div class='textoDependiente'>";
                                echo "\"Revistas, Coleccionables, Maquetas... a buen precio\".";
                            echo "</div>";
                            echo "<div class='imagenDependiente'>";
                                echo '<img src="/design/img/dependientes/todoMascota.png">';
                            echo "</div>"; //FIN imagenDependiente
                            $imagenPurpurina = getFotoObjeto(112);
                            $imagenNave = getFotoObjeto(1000);
                            $imagenRevista = getFotoObjeto(315);
                           
                            echo "<div class='opcionesTienda " . 1 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="purpurina">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Purpurina Cosmética';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenPurpurina . '</div><div class="monedaTienda"></div><div class="precioTienda">250</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 2 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="revista">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Revista Científica';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenRevista . '</div><div class="monedaTienda"></div><div class="precioTienda">300</div></label>';
                            echo "</div>";
                            echo "<div class='opcionesTienda " . 3 . "'>";
                                echo "<div class='opcionesTiendaCheckbox'>";
                                    echo '<input type="checkbox" name="cbox1" value="sfxArwing">';
                                echo "</div>";
                                echo "<div class='opcionesTiendaTitulo'>";
                                    echo 'Maqueta SFX Arwing';
                                echo "</div>";
                                echo '<label for="cbox3"><div id="opcionBox">' . $imagenNave . '</div><div class="monedaTienda"></div><div class="precioTienda">5000</div></label>';
                            echo "</div>";
                    ...
                    echo "<div id='vender'>";
                            ...
                            echo '<form id = "selectorOpciones" action="?bPage=actualizaciones&action=accionSpot&nonUI" method="post">';
                            echo "<div class='textoDependiente'>";
                                echo "\"En mi Kiosko se vendería bien tu mercancía\".";
                ...
                echo "<div class='seccionSpotInfo'>";
                    echo "<div class = 'seccionContacto'>";
                        echo "<div class = 'mapaCallejero'>";
                            echo '<iframe width="300" height="225" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=-4.108280539512635%2C38.683809654171206%2C-4.1013818979263315%2C38.68673665859128&amp;layer=mapnik&amp;marker=38.68527327020567%2C-4.104832291341154" style="border: 1px solid silver; border-radius:15px;"></iframe><br/><br>';    
                        echo "</div>";
                        echo "<div class = 'semiTransparente'>";
                        echo "<div class = 'infoSpot'>";
                            echo "<table border = '0' style = 'text-align:left'>";
                                echo "<tr>";
                                    echo "<td><div class='mapaMini'></div> C/Goya, 15<br></td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td><div class='telefonoMini'></div> 926 43 15 70<br></td>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<td><div class='relojMini'></div> 09:30 - 14:30, 17:30 - 21:00</td>";
                                echo "</tr>";
                            echo "</table>";
                        echo "</div>";
                        echo "</div>"; //FIN Semitransparente
                    ...
                    echo "<div class = 'seccionInsignia'>";
                        $fechaInsignia = comprobarInsignia(33);
                        if ($fechaInsignia != '0'){
                            $fotoInsignia = getFotoInsignia(33);
