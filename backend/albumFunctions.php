            ...
            echo "<tr>";
                for($i=7; $i<=9; $i++){
                    echo "<td>";
                        ...
                        if(isset($ver[0])){
                            echo "<div class='albumTarjeta'>";
                                echo "<div class='albumTarjetaTitulo'>";
                                    $monstruo = getMonstruoRow($ver[0]['idM']);
                                    echo $monstruo[0]['nombre'];
                                    //Catalogar las habilidades del monstruo
                                    $monstruoAtaque = ($monstruo[0]['destreza'] + $monstruo[0]['fuerza'])/2;
                                    ...
                                    $monstruoSalud = ($monstruo[0]['salud']);
                                echo "</div>";
                                    echo '<div id="opcionBox">' . '<img src="/design/img/monstruos/' . $ver[0]['idM'] . '"></div>' ./*'<div class="monedaTienda"></div>'<div class="precioTienda">' . $ver[0]['cantidad'] . ' veces</div><br>'.*/
                                         ' <div class="precioTienda">' . $monstruoSalud . '</div><br><div class="precioTienda">' . $monstruoAtaque . '</div><br><div class="precioTienda">' . $monstruoDefensa . '</div>';
                                echo "<div id='vecesDerrotado'>";
                                        echo $ver[0]['cantidad'];
                                echo "</div>";
                            echo "</div>";                          
                        }
